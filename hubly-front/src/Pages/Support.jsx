          ...
          <div className="chatheaders">
            ...
            flexDirection: "column",}}>
              <div className='user-msg'>Hey</div>
                    {messages.map((msg)=>(
                      <div key={msg._id} className={msg.senderModel=== "User"?"support-msg":"user-msg"}>{msg.message}</div>
                    ))}
                    </div>
                   
                <div className='user-info' style={{ display: token ? "none" : "block" }}> 
                <p style={{
                 margin:"10px 0"
                ...
                <form>
                 ...
                 <button style={{
                     ...
                     color:"white",
                     margin:"0 7vw",
                 }} onClick={registerHandler}>Thank you</button>
                </form> 
                   
                </div>  
                <textarea name="message" id="message"  placeholder="Write a message" style={{
                  border:"none",
                  fontSize:"17px",
                  height:"6vh",
                  width:"inherit",
