...
>
  ...
  <option value="admin">Admin</option>
          ...
          <button style={{
            ...
            float:"right",
            marginLeft:"10px",
          }}  onClick={addHandler}>Save</button>
          <button style={{
            width:"10vw",
            height:"5vh",
            color:"grey",
            ...
            borderRadius:"12px",
            float:"right",
          }} onClick={()=>setShowForm(!showForm)}>Cancel</button>
          </form>
            </div>
            <button style={{
                width:"10vw",
            ...
            }} onClick={()=>setShowForm(!showForm)}> Add Team Members</button>
          </div>
        );
      }
